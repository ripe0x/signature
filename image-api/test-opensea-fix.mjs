 ...
 *
 * Run from image-api directory: node test-opensea-fix.mjs
 */
...
try {
  execSync('npm run build:onchain', { cwd: rootDir, stdio: 'pipe' });
...
const escapedJs = readFileSync(join(rootDir, 'web/onchain/bundled.js'), 'utf8');
